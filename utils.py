...
def plot_hysteresis_info(hysteresis_info, i=None, predicted_price=None):
    ...
    for index, info in enumerate(hysteresis_info):
        ...
        if index == 0:
            ...
            plt.plot(prev_price, vertical_line, color='red', label='previous price', linewidth=1)
            plt.plot(curr_price, vertical_line, color='blue', label='current price', linewidth=1)
            plt.plot(_predicted_price, vertical_line, color='black', label='predicted price', linewidth=2)
            plt.plot(prices, noise, color=colors[index % len(colors)], marker='o', markersize=4, label='steps finding root', linewidth=2)
        else:
            ...
            plt.plot(prev_price, vertical_line, color='red', label=None, linewidth=1)
            plt.plot(curr_price, vertical_line, color='blue', label=None, linewidth=1)
            plt.plot(_predicted_price, vertical_line, color='black', label=None, linewidth=2)
            plt.plot(prices, noise, color=colors[index % len(colors)], marker='o', markersize=4, label=None, linewidth=2)
