...
def loop(method, weight, width, bz, nb_plays):
    ...
    fname = constants.FNAME_FORMAT["models_G"].format(method=method, weight=weight,
    ...
    for nb_plays_ in constants.NB_PLAYS:
        ...
        fname = constants.FNAME_FORMAT["models_G_loss"].format(method=method, weight=weight,
        ...
        fname = constants.FNAME_FORMAT["models_G_predictions"].format(method=method, weight=weight,
                                                                      width=width, nb_plays=nb_plays,
                                                                      nb_plays_=nb_plays,
                                                                      batch_size=bz)
