...
#SBATCH -J run_MLE-nb_plays-100-units-100-activation-elu-batch-size-1000-ensemble-2
#SBATCH -D /home/zxchen/feng
#SBATCH -o ./tmp/run_MLE-nb_plays-100-units-100-activation-elu-batch-size-1000-ensemble-2.out
#SBATCH --nodes=1
#SBATCH --mem=80G
